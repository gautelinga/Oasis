...
u_shift[num_edge+num_unique/2:, :] = u[num_edge:num_edge+num_unique/2, :]
u_shift[:num_edge, :] = u[:num_edge, :]
...
p_shift[num_edge:num_edge+num_unique/2, :] = p[num_edge+num_unique/2:, :]
p_shift[num_edge+num_unique/2:, :] = p[num_edge:num_edge+num_unique/2, :]
p_shift[:num_edge, :] = p[:num_edge, :]
