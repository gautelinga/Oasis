...
init_folder = "duct2200_results/data/10/Timeseries/"
h5fu_str = init_folder + "u_from_tstep_0.h5"
h5fp_str = init_folder + "p_from_tstep_0.h5"
step = "4161"  # which timestep within the timeseries do we initialize from?

# Body force
F_0 = 8.0e-6  # approx Re=2200
